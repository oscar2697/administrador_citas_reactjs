...
const Formulario = ({pacientes ,setPacientes, paciente, setPaciente}) => {
    ...
    return (
        <div className='md:w-1/2 lg:w-2/5 mx-5'>
            <h2 className='font-black text-3xl text-center'>Seguimiento de Pacientes 🧑🏻‍⚕️</h2>
            ...
            {error && <Error><p>Todos los Campos son Necesarios</p></Error>}
                ...
                <input type='submit' 
                    className='bg-indigo-600 w-full p-3 text-white uppercase font-bold hover:bg-indigo-700 cursor-pointer transition-alt' 
